...
![The first screen, plain black](1-first-screen.png)

The ticker strip and the three boxes:

![The red ticker strip and the three bordered boxes](2-boxes.png)

The photo grid with nothing in the folder:

![The photo grid showing labelled empty slots](3-photo-grid.png)

## The enquiry form

![The enquiry form](4-form.png)
